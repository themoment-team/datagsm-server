package team.themoment.datagsm.domain.oauth.dto.request
...
data class OauthCodeReqDto(
    ...
    @param:Schema(description = "사용자 이메일", example = "user@gsm.hs.kr")
    val email: String,
    @field:NotBlank(message = "비밀번호는 필수입니다.")
    @param:Schema(description = "사용자 비밀번호", example = "password123!")
    val password: String,
