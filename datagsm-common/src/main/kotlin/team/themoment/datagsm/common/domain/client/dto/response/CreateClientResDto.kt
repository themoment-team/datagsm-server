...
data class CreateClientResDto(
    @field:Schema(description = "생성된 클라이언트 ID", example = "a1b2c3d4-e5f6-7890-abcd-ef1234567890")
    val clientId: String,
    @field:Schema(description = "생성된 클라이언트 Secret (최초 1회만 반환)", example = $$"$2a$12$p2631BskS5B4yknxhj4UIuoVg8S8BGCXRcanzBZF/VlASgc9gFhjG")
    ...
    @field:Schema(description = "OAuth 권한 범위 목록", example = "[\"self:read\", \"student:read\"]")
