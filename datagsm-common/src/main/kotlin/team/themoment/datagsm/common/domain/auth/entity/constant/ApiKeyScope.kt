package team.themoment.datagsm.common.domain.auth.entity.constant
...
enum class ApiKeyScope(
    ...
    companion object {
        ...
        fun getScopesByRole(role: AccountRole): List<ApiKeyScope> =
        ...
        fun groupByCategory(scopes: List<ApiKeyScope>): Map<String, List<ApiKeyScope>> = scopes.groupBy { it.categoryDisplayName }
    }
}
