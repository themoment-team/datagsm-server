            ...
            describe("execute 메서드는") {
                ...
                context("검색 결과가 있을 때") {
                    ...
                    beforeEach {
                        ...
                        every { mockStudentRepository.findByMajorClubWithAccount(e1) } returns emptyList()
                        every { mockStudentRepository.findByMajorClubWithAccount(e2) } returns emptyList()
                    }
                ...
                context("Pageable로 검색하고 결과가 있을 때") {
                    ...
                    beforeEach {
                        ...
                        every { mockStudentRepository.findByMajorClubWithAccount(any()) } returns emptyList()
                    }
